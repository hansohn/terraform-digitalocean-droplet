...
| <a name="input_public_lb_firewall"></a> [public\_lb\_firewall](#input\_public\_lb\_firewall) | (Optional) - A block containing rules for allowing/denying traffic to the Load Balancer. The firewall block is documented below. Only 1 firewall is allowed. | `list(any)` | `[]` | no |
